import scrapy 
from sephora_project.sephora_project.items import SephoraProjectItem
import re
import pandas as pd
import json
import math
...
class SephoraSpider(scrapy.Spider):
    ...
    #first is to collect all links for brands 
    ...
    def parse_product(self, response):
        ...
        product_df = pd.DataFrame({'links2': links2,'product_names': product_names,'p_id': product_ids, 'ratings': ratings,'brand_names': brand_names})
